...
public class Dip {
    ...
    private static int MAX_STARS=2;
    private static int MAX_NUMBERS_VALUE=49;
    private static int MAX_STARS_VALUE=9;
    private static int HASH_MULTIPLIER=29;
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < MAX_NUMBERS; ) {
            int candidate = generator.nextInt(MAX_NUMBERS_VALUE) + 1;
        ...
        for (int i = 0; i < MAX_STARS; ) {
            int candidate = generator.nextInt(MAX_STARS_VALUE) + 1;
    ...
    public int hashCode() {
        int hash = 3;
        hash = HASH_MULTIPLIER * hash + Objects.hashCode(this.numbers);
        hash = HASH_MULTIPLIER * hash + Objects.hashCode(this.starts);
        return hash;
    }
    ...
    public String format() {
        ...
        sb.append("N[");
        for (int number : this.getNumbersColl()) {
            sb.append(String.format("%3d", number));
        }
        sb.append("] S[");
        for (int star : this.getStarsColl()) {
